...
public class CustomExceptionHandler {
    ...
    public final ResponseEntity<JSONObject> invalidUser(BadCredentialsException e) {
        log(e);
        return new ResponseEntity<>(JSONObject.of("code",
                HttpStatus.UNAUTHORIZED.value(),
                "message", e.getMessage()
        ), HttpStatus.UNAUTHORIZED);
    }

    @ExceptionHandler(value = {ExpiredJwtException.class, AccountExpiredException.class, ClaimJwtException.class})
    public final ResponseEntity<JSONObject> expiredToken(ExpiredJwtException e) {
